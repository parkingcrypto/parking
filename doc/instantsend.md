...
This mechanism has been integrated into Bitcore-Node-Parking which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/parkingcrypto/insight-api-parking#web-socket-api](https://github.com/parkingcrypto/insight-api-parking#web-socket-api)
* API: [https://github.com/parkingcrypto/insight-api-parking#instantsend-transactions](https://github.com/parkingcrypto/insight-api-parking#instantsend-transactions)
...
By default, the Parking Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Parking Core daemon:
