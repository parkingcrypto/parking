...
This document provides guidelines for internationalization of the Parking Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `parking_en.ts` remains unchanged.
