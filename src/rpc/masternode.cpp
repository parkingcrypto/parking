...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Parking address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "parking",               "masternode",             &masternode,             true,  {} },
    { "parking",               "masternodelist",         &masternodelist,         true,  {} },
    { "parking",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "parking",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "parking",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "parking",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
