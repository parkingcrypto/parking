...
2. run parkingd with -printalert or -sendalert like this:
   /path/to/parkingd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.parkcoin.club";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Parking Core:0.12.0.58/"));
