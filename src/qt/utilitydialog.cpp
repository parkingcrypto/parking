    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  parking-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Parking in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 PARK, 0.1 PARK, 1 PARK and 10 PARK -- sort of like the paper money you use every day.</li> \
